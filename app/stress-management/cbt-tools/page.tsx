      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card title="Thought Record">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="thought" className="block text-sm font-medium text-gray-700">Negative Thought</label>
              <Textarea
                id="thought"
                value={thought}
            ...
            <div>
              <label htmlFor="alternative" className="block text-sm font-medium text-gray-700">Alternative Thought</label>
              <Textarea
                id="alternative"
        ...
        <Card title="Relaxation Techniques">
          ...
          <Button onClick={() => handleClick("https://www.youtube.com/playlist?list=PLsBkCd3sfc6hJP4OQS4pFkaliFXpakOum&jct=08y7EqQGe8q1XboBNUF5EA")}>Let's Start</Button>
        </Card>
      </div>
    </Layout>
  )
