      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card title="Self-Care Resources">
          <ul className="list-disc list-inside space-y-2">
            <li><Link href="https://youtu.be/cyMxWXlX9sU" className="text-blue-600 hover:underline">Guided meditation audio</Link></li>
            <li><Link href="https://youtu.be/yqeirBfn2j4" className="text-blue-600 hover:underline">Stress-relief exercises</Link></li>
            <li><Link href="https://youtu.be/ERysyFbJH7w" className="text-blue-600 hover:underline">Healthy recipe ideas</Link></li>
            <li><Link href="https://youtu.be/lRp5AC9W_F8" className="text-blue-600 hover:underline">Sleep improvement tips</Link></li>
          </ul>
        </Card>
      </div>
    </Layout>
