...
export default function DiscussionForums() {
  ...
  useEffect(() => {
    ...
    setThreads([
      { id: 1, title: "Coping with work-related stress", author: "StressLess123", replies: 15, lastActivity: "2 hours ago" },
      { id: 2, title: "Meditation techniques for beginners", author: "ZenMaster", replies: 8, lastActivity: "1 day ago" },
      { id: 3, title: "Dealing with anxiety during social events", author: "SocialButterfly", replies: 22, lastActivity: "3 hours ago" },
      { id: 4, title: "The benefits of journaling for mental health", author: "WriterAtHeart", replies: 12, lastActivity: "5 hours ago" },
    ])
  }, [])
      ...
      {isCreatingThread && (
        <Dialog open={isCreatingThread} onOpenChange={setIsCreatingThread}>
          <DialogContent>
            ...
            />
            <Button onClick={handleCreateThread} className="mt-2">Post Thread</Button>
            <DialogClose asChild>
