  ...
  return (
    <header className="bg-beige text-black p-4 shadow-md">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <Link href="/" className="text-2xl font-bold mb-4 md:mb-0">VitalSpace</Link>
        <nav>
...
function NavItem({ href, icon: Icon, text }: { href: string; icon: React.ElementType; text: string }) {
  return (
    <li>
      <Link href={href} className="flex items-center hover:underline p-2 rounded-md hover:bg-cream transition-colors duration-200">
